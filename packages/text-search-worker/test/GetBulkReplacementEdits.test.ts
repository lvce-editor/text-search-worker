...
test('getBulkReplacementEdits - different file paths', () => {
  ...
  expect(GetBulkReplacementEdits.getBulkReplacementEdits(workspacePath, matches)).toEqual({
    files: ['memfs:///test/file.txt'],
    ranges: [4, 0, 0, 0, 1],
  })
})
